...
def setup_product():
    ...
    import Products.eJSubscriptions
    zcml.load_config('configure.zcml', Products.eJSubscriptions)
    ...
    ztc.installPackage('Products.eJSubscriptions')
...
setup_product()
ptc.setupPloneSite(products=['Products.eJSubscriptions'])
