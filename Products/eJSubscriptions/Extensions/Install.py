...
from Products.eJSubscriptions.config import PROJECTNAME
from Products.eJSubscriptions.config import product_globals as GLOBALS

def install(self):
    """ External Method to install eJSubscriptions """
    out = StringIO()
    ...
    try:
        from Products.eJSubscriptions.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.eJSubscriptions.config import STYLESHEETS
    try:
        ...
        pass
    from Products.eJSubscriptions.config import JAVASCRIPTS
    try:
